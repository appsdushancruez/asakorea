...
export default function PhysicalAttendancePage() {
    ...
    <div className="pb-24 sm:pb-0">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-semibold text-gray-900">Physical Classes Attendance</h1>
          <p className="mt-2 text-sm text-gray-700">
            Take attendance for physical Korean language classes.
          </p>
        </div>
      </div>
