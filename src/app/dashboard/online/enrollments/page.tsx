  ...
  return (
    <div className="space-y-6">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Online Class Enrollments</h1>
          <p className="mt-2 text-sm text-gray-700">
            Manage student enrollments for online classes
          </p>
        </div>
      </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-pink-700">-</p>
                </div>
                <button
