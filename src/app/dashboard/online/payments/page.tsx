  ...
  const fetchPayments = async () => {
    try {
      ...
      const { data, error } = await supabase
        ...
        .select(`
          *,
          students:student_id(name, photo_url, student_number),
  ...
  return (
    <div className="space-y-6">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Online Class Payments</h1>
          <p className="mt-2 text-sm text-gray-700">
            Manage student payments for online classes
          </p>
        </div>
        <button
