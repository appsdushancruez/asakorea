    ...
    <div>
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-semibold text-gray-900">Online Class Students</h1>
          <p className="mt-2 text-sm text-gray-700">
            A list of all students enrolled in online Korean language classes.
          </p>
        </div>
        ...
        <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
              <table className="min-w-full divide-y divide-pink-200 overflow-x-auto text-xs sm:text-sm bg-gradient-to-br from-pink-100 via-blue-50 to-yellow-50">
